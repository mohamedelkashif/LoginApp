...
function SmartWizard(target, options) {
    ...
    this.contentWidth = 0;
    this.msgBox = $('<div class="msgBox hide"><div class="content"></div><a href="#" class="close">X</a></div>');
    this.elmStepContainer = $('<div></div>').addClass("stepContainer");
    this.loader = $('<div>Loading</div>').addClass("loader");
    this.buttons = {
        next : $('<a>'+options.labelNext+'</a>').attr("href","#").attr("id","wizardNext").addClass("buttonNext btn btn-default pull-right"),
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious btn btn-default pull-left"),
        finish  : $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("buttonFinish hide")
    };
    ...
    var _init = function($this) {
        ...
        $($this.buttons.next).click(function() {
            $this.goForward();
            $this.buttons.next.addClass('btn-disable');
            return false;
        });
